                            ...
                            <li class="active">
                                <a  href=""><i class="fa fa-car"></i> <span class="nav-label">CarPark</span><span class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level collapse" >
                                        ...
                                        <li class="active"><router-link to="/carparks/street">Street</router-link></li>
                      ...
                      <div class="col-lg-6">
                           <div class="input-group" style="margin-bottom: 20px">
                            ...
                            <div class="input-group" style="margin-bottom: 20px">
                                ...
                                <button class="btn btn-primary btn-sm" @click="filterZoneByStreet">Filter by street</button>
                            </div>
                    </div>
                    <div class="col-lg-2">
