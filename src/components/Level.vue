                            ...
                            <li class="active">
                                <a  href=""><i class="fa fa-car"></i> <span class="nav-label">CarPark</span><span class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level collapse" >
                                        ...
                                        <li class="active"><router-link to="/carparks/level">Level</router-link></li>
...
export default {
  ...
  methods: {
    addLevel() {
        axios
        .get(`https://sys2.parkaidemobile.com/api/carparks/${this.selected}/levels`,{headers: { 'x-access-token': JSON.parse(this.token)}})
        .then(response => {
